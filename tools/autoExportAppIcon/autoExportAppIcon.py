...
#------------------- add by szm.
# 50x50
img14 = originImg.resize((50,50), Image.ANTIALIAS)
img15 = originImg.resize((100,100), Image.ANTIALIAS)
img14.save(outPutPath + 'appIcon50x50.png',"png")
img15.save(outPutPath + 'appIcon50x50@2x.png',"png")
# 57x57
img16 = originImg.resize((57,57), Image.ANTIALIAS)
img17 = originImg.resize((114,114), Image.ANTIALIAS)
img16.save(outPutPath + 'appIcon57x57.png',"png")
img17.save(outPutPath + 'appIcon57x57@2x.png',"png")
#------------------- add end.
